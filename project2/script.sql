...
INSERT INTO EMPLOYEES (BIRTH_NUMBER, FIRST_NAME, FAMILY_NAME) VALUES ('630329/0015', 'Jakub', 'Kubát');
INSERT INTO EMPLOYEES (BIRTH_NUMBER, FIRST_NAME, FAMILY_NAME) VALUES ('622930/0015', 'Karína', 'Kubátová');
INSERT INTO EMPLOYEES (BIRTH_NUMBER, FIRST_NAME, FAMILY_NAME) VALUES ('560423/1125', 'Maria', 'Procházková');
INSERT INTO EMPLOYEES (BIRTH_NUMBER, FIRST_NAME, FAMILY_NAME) VALUES ('780313/1325', 'Jan', 'Horák');

INSERT INTO DOCTORS (ID, MEDICAL_SPEC, PHONE_NUMBER, EMAIL) VALUES (1, 'neurolog', '+420111222333', '123@123.cz');
INSERT INTO DOCTORS (ID, MEDICAL_SPEC, PHONE_NUMBER, EMAIL) VALUES (2, 'chirurg', '+420121212343', '1231@123.cz');
INSERT INTO DOCTORS (ID, MEDICAL_SPEC, PHONE_NUMBER, EMAIL) VALUES (4, 'chirurg', '+420221212343', '11231@123.cz');

INSERT INTO NURSES (ID, SPECIALIZATION) VALUES (3, 'sestra na oddělení');
INSERT INTO NURSES (ID, SPECIALIZATION) VALUES (5, 'sestra na ošetřovně');

INSERT INTO DEPARTMENTS (ABBREVIATION, NAME, BED_NUMBER, MANAGER_ID) VALUES ('NEUR', 'Neurologie', 50, 1);
INSERT INTO DEPARTMENTS (ABBREVIATION, NAME, BED_NUMBER, MANAGER_ID) VALUES ('CHIR', 'Chirurgie', 50, 2);


INSERT INTO DOCTORS_DEPARTMENTS (DOCTOR_ID, ABBREVIATION) VALUES (1, 'NEUR');
INSERT INTO DOCTORS_DEPARTMENTS (DOCTOR_ID, ABBREVIATION) VALUES (2, 'CHIR');
INSERT INTO DOCTORS_DEPARTMENTS (DOCTOR_ID, ABBREVIATION) VALUES (2, 'NEUR');
INSERT INTO DOCTORS_DEPARTMENTS (DOCTOR_ID, ABBREVIATION) VALUES (4, 'CHIR');
...
VALUES (1, TO_DATE('2019-03-25 20:03:44', 'YYYY-MM-DD HH24:MI:SS'), 'Bolesti hlavy, migrena',1);
INSERT INTO HOSPITALIZATIONS (PATIENT_ID, DATE_HOSP, DIAGNOSIS, DOCTOR_ID)
VALUES (2, TO_DATE('2020-04-21 07:04:55', 'YYYY-MM-DD HH24:MI:SS'), 'Žlučníkové kameny',2);

INSERT INTO NURSES_PATIENTS (NURSE_ID, ID_HOSPITALIZATION) VALUES (3, 1);
INSERT INTO NURSES_PATIENTS (NURSE_ID, ID_HOSPITALIZATION) VALUES (5, 1);

INSERT INTO INSPECTIONS_DESC (ABBREVIATION, NAME) VALUES ('KRBI', 'Biochemická analýza krve');
INSERT INTO INSPECTIONS_DESC (ABBREVIATION, NAME) VALUES ('UZBR', 'Ultrazvuk břicha');
INSERT INTO INSPECTIONS_DESC (ABBREVIATION, NAME) VALUES ('KRGL', 'Glukóza v krvi');
